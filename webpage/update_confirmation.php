	...
	else
	{
		...
		$mysqli->set_charset('utf8');
		 ...
		 //  echo $_POST['name'];
			...
			// echo $price_id;
			// echo $rating_id;
		  // echo $_POST['restaurant_title_id'];

		  $statement = $mysqli->prepare("UPDATE restaurant SET name=?, state=?,city=?,street=?,img=?,comment=?,type_id=?, price_id=?, rating_id=? WHERE id=?");

		  $statement->bind_param("ssssssiiii", $_POST['name'],$state,$city,$_POST['street'],$theimage, $comment, $type_id, $_POST['price_id'], $_POST['rating_id'],$_POST['restaurant_title_id']);
...
<head>
    ...
    <title>Update_Confirmation</title>
	...
	<div class="output">
				...
				<?php if ($isUpdated) : ?>
					<div class="text-success">
						You edited <?php echo $_POST['name']; ?> successfully.
					</div>
				<?php endif; ?>
	</div>
	<div class="thebutton">
